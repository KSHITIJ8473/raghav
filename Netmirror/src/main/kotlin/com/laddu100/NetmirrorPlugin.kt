...
open class NetmirrorPlugin: Plugin() {
    override fun load(context: Context) {
        ...
        val sharedPref = context.getSharedPreferences("NetmirrorStudios", Context.MODE_PRIVATE)
        ...
        openSettings = {
            val frag = NetmirrorSettings(this, sharedPref, studioOptions)
            frag.show(activity.supportFragmentManager, "NetmirrorSettings")
        }
    }
