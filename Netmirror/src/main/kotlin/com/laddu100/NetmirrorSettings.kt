...
// Studio toggle entry for Netmirror
data class StudioOption(val key: String, val label: String, val cookieValue: String)

class NetmirrorSettings(
    private val plugin: NetmirrorPlugin,
    ...
    private fun getStudioRow(option: StudioOption): RelativeLayout {
        val relativeLayout = RelativeLayout(this@NetmirrorSettings.requireContext()).apply {
        ...
        val checkBox = CheckBox(this@NetmirrorSettings.requireContext()).apply {
        ...
        val textView = TextView(this@NetmirrorSettings.requireContext()).apply {
            id = View.generateViewId()
            text = option.label
            textSize = 16f
            layoutParams = RelativeLayout.LayoutParams(
